            ...
            <div class="grid md:grid-cols-4 gap-12 mb-20">
                <div class="col-span-2 space-y-8">
                    ...
                    <div class="flex gap-4">
                        <a href="#" class="w-12 h-12 rounded-2xl flex items-center justify-center bg-white shadow-lg text-gray-700 hover:bg-bakery-orange hover:text-white transition-all duration-300 group">
                            <svg class="w-6 h-6 group-hover:scale-110 transition-transform fill-current" viewBox="0 0 24 24">
                        ...
                        <a href="#" class="w-12 h-12 rounded-2xl flex items-center justify-center bg-white shadow-lg text-gray-700 hover:bg-bakery-orange hover:text-white transition-all duration-300 group">
                            <svg class="w-5 h-5 group-hover:scale-110 transition-transform fill-current" viewBox="0 0 24 24">
